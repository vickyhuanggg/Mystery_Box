...
class Start:
    ...
    def check_funds(self):
        ...
        # disabled all stakes buttons in case user changes mind and decreases amount entered
        self.low_stakes_button.config(state=DISABLED)
        self.medium_stakes_button.config(state=DISABLED)
        self.high_stakes_button.config(state=DISABLED)
...
class Game:
    def __init__(self, partner, stakes, starting_balance):
        ...
        self.starts_button = Button(self.help_export_frame, text="Game Stats...",
    ...
    def reveal_boxes(self):
        ...
        round_summary = "{} | {} | {} - Cost: ${} | "\
                        ...
                        "${}".format(stats_prizes[0], stats_prizes[1],
                                     stats_prizes[2], 5*stakes_multiplier,
                                     round_winnings, current_balance)
